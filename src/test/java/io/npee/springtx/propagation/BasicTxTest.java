...
public class BasicTxTest {
    ...
    @Test
    void inner_commit_and_outer_commit() {
        log.info("외부 트랜잭션 시작");
        ...
        log.info("내부 트랜잭션 커밋");
        txManager.commit(inner); //ignored
    ...
    void inner_rollback() {
        ...
        TransactionStatus inner = txManager.getTransaction(new DefaultTransactionAttribute());
        log.info("내부 트랜잭션 롤백");
        txManager.rollback(inner); //not ignored - marking existing transaction as rollback-only
